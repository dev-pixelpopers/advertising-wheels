...
/**
 * SiteHeader — the shared header for every inner page.
 *
 * The home page keeps its own bespoke header (revealed by the Hero's scroll
 * timeline). Inner pages sit on a solid cream/dark ground instead, so this
 * variant is sticky, picks up a frosted background + hairline once the page
 * scrolls, highlights the active route, and collapses into a slide-down panel
 * on mobile. Nav links come from the shared NAV_LINKS config.
 */
