    ...
    return (
        ...
        <div className="case-study relative mx-auto w-full max-w-[1500px] 2xl:px-[40px] 3xl:px-[60px] pt-[60px] md:pt-[120px] lg:pt-0 h-screen flex flex-col lg:flex-row lg:items-center lg:gap-[4%] overflow-hidden">
            <div className="w-full lg:w-[38%] shrink-0 flex justify-start">
                <div className="cs-left flex flex-col justify-center items-start">
                    ...
                    <div className="flex items-center gap-4">
                        <span className="h-px w-[44px] bg-black/30  xl:w-[64px]" />
                        <span className="font-tommy-regular text-[10.5px] uppercase tracking-[0.3em] text-[#8A857C]  md:text-[12px]">
                            Case Studies
                        </span>
                    </div>
                    ...
                    <h2 className="mt-5 font-tommy-bold text-[clamp(2rem,4vw,4.25rem)] leading-[0.96] tracking-[-0.025em] text-[#1A1917]  md:mt-7">
                        Explore our
                        <br />
                    ...
                    <p className="mt-5 max-w-[44ch] font-tommy-regular text-[15px] leading-[1.72] text-[#5A554C]  md:mt-7 md:text-[17px]">
            ...
            <div className="cs-carousel flex-1 relative md:mt-[40px] lg:mt-0 lg:h-[85vh] overflow-hidden">
                {caseStudies.map((cs, index) => (
                    <div key={index} className="cs-card absolute inset-0 flex flex-col items-center lg:items-end justify-center top-0 lg:pt-[10%]">
                        ...
                        >
                            <div className="w-full rounded-[8px] border border-[#F0F0F0] bg-[#FFF] py-[10px] px-[10px] flex flex-col gap-2 md:gap-4 xl:gap-6 2xl:gap-8  shadow-sm">
                                <div className="flex flex-row justify-between pt-[10px] md:pt-[12px] lg:pt-[16px] xl:pt-[22px] 2xl:pt-[30px] pl-[15px]">
                                    <div>
                                        ...
                                        <span className="block font-tommy-regular text-[9.5px] uppercase tracking-[0.26em] text-[#8A857C]  md:text-[10.5px]">
                                            {cs.sector}
                                        </span>
                                        <div className="mt-2 overflow-hidden md:mt-3">
                                            <h2 className="cs-title text-[18px] sm:text-[clamp(1.75rem,2.5vw,2.625rem)] font-tommy-bold leading-[1.02] tracking-[-0.02em] uppercase text-black ">{cs.title}</h2>
                                        </div>
                                    </div>
                                    ...
                                    <span className="mt-[-10%] shrink-0">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="w-[60px] md:w-[70px] lg:w-[90px] xl:w-[119px] h-[60px] md:h-[70px] lg:h-[90px] xl:h-[119px] rotate-[90deg]" width="119" height="119" viewBox="0 0 119 119" fill="none">
                                            <circle cx="59.5" cy="59.5" r="59.5" className="fill-black " />
                            ...
                            <div className="cs-stats relative z-[2] w-[92%] mx-auto rounded-[8px] border border-[#F0F0F0] bg-[#FFF] flex flex-row gap-[10px] md:gap-[16px] xl:gap-[20px] -mt-[60px] p-[6px] md:p-[8px]  shadow-sm">
                                ...
                                <div className="w-[30%] shrink-0 rounded-[8px] bg-[#202020] px-[8px] md:px-[14px] ">
                                ...
                                <div className="min-w-0 flex-1">
                                    ...
                                    <ul className="cs-labels flex flex-col py-[8px] md:py-[10px] text-[#1A1917] text-[10px] sm:text-[12px] md:text-[clamp(0.8rem,1.02vw,1rem)] leading-[1.25] capitalize font-tommy-medium ">
                                        {cs.stats.map((s, i) => (
            ...
            <div className="cs-outro absolute inset-0 z-20 flex flex-col items-center justify-center text-center sm:px-[20px] md:px-[60px]">
                <span className="cs-outro-item font-tommy-regular text-[10.5px] md:text-[12px] tracking-[0.3em] uppercase text-[#8A857C] ">
                    More work
                </span>
                {/* Matches the section opener: bold, tight tracking, sentence case —
                    `capitalize` here was title-casing the whole line. */}
                <h2 className="cs-outro-item mt-4 md:mt-5 font-tommy-bold text-[24px] sm:text-[clamp(38px,4.4vw,72px)] leading-[0.98] tracking-[-0.025em] text-[#1A1917] max-w-[16ch] text-balance ">
                    See how other brands own the street<span className="text-[#C8992B]">.</span>
                </h2>
                <p className="cs-outro-item mt-5 md:mt-6 font-tommy-regular text-[15px] md:text-[17px] leading-[1.72] text-[#5A554C] max-w-[56ch] ">
