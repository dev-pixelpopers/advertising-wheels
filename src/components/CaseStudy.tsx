export default function CaseStudy() {
    return (
        <div className="mt-[150px] w-full max-w-[90%] mx-auto flex flex-row">
            <div className="w-[50%] flex justify-end">
                <div className="flex flex-col gap-10 justify-center items-end">
                    <div className="flex flex-row gap-10 w-fit justify-end">
                        <div className="border border-t-black h-[2px] w-[126px] my-auto"></div>
                        <h2 className="font-tommy-medium text-[66px] capitalize text-black max-w-[50%] leading-[100%]">explore our case study</h2>
                    </div>
                    <p className="font-tommy-regular text-[21px] leading-[30px] text-black max-w-[68%] capitalize">Our client, a growing consumer brand, wanted to increase brand awareness and reach a wider audience in key urban markets.</p>
                </div>
            </div>
            <div className="w-[55%]">
                <div className="w-[650px] rounded-[8px] border border-[#F0F0F0] bg-[#FFF] py-[10px] px-[10px] flex flex-col gap-10">
                ...
                <div className="relative w-[90%] rounded-[8px] border border-[#F0F0F0] bg-[#FFF] py-[5px] flex flex-row gap-[10px] mx-auto -mt-[15%] px-[5px]">
