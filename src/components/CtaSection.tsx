...
export default function CtaSection() {
    ...
    return (
        <div ref={rootRef} className="w-full bg-[#FCD119] px-6 py-[100px] md:px-14 md:py-[140px]">
            <div data-cta className="mx-auto flex max-w-[1100px] flex-col items-center text-center">
