...
export default function Preloader({ onComplete }: PreloaderProps) {
  ...
  return (
    <div
      ref={containerRef}
      className="fixed inset-0 z-50 gap-30 flex flex-col items-center justify-center bg-[#EEE8D9] text-[#1A1917]"
    >
      <div className='flex flex-col justify-center items-center'>
        <svg className="preloader-logo opacity-0" width="150" height="70" viewBox="0 0 120 50" fill="none" xmlns="http://www.w3.org/2000/svg">
