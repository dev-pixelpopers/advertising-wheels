  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-y-1 text-center md:gap-y-2">
        ...
        <span className="preloader-word font-tommy-regular text-2xl leading-none opacity-0">
          {FINAL_WORD}
        </span>
      </div>
    </div>
