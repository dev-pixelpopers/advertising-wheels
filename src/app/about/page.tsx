        ...
        <section ref={rootRef} className="relative w-full overflow-hidden bg-[#EEE8D9] py-24 transition-colors duration-300 md:py-32 dark:bg-[#0A0A0A]">
            ...
            <div className="relative z-10 mx-auto grid max-w-[1200px] grid-cols-1 items-center gap-14 px-6 md:px-12 lg:grid-cols-[1.1fr_0.9fr] lg:gap-20">
                ...
                <div className="relative">
                    ...
                    <div data-story-badge className="absolute -bottom-6 -left-6 rounded-2xl bg-[#1A1917] px-6 py-5 shadow-xl dark:bg-[#FCD119]">
...
function Stats() {
    ...
    return (
        <section className="w-full border-y border-black/10 bg-[#EEE8D9] py-20 transition-colors duration-300 md:py-24 dark:border-white/10 dark:bg-[#0A0A0A]">
            <Reveal className="mx-auto grid max-w-[1200px] grid-cols-2 gap-x-8 gap-y-12 px-6 md:px-12 lg:grid-cols-4" y={30} stagger={0.14}>
                {items.map((s, i) => (
...
function Timeline() {
    ...
    return (
        <section ref={rootRef} className="relative w-full overflow-hidden border-y border-black/10 bg-[#E7E0CE] text-[#1A1917] transition-colors duration-300 lg:h-screen dark:border-white/10 dark:bg-[#141414] dark:text-white">
            <div className="pointer-events-none absolute inset-x-0 top-0 z-20 px-6 pt-[92px] md:px-12 lg:pt-[13vh]">
            ...
            <div ref={trackRef} className="flex flex-col gap-6 px-6 pb-16 pt-[220px] md:px-12 lg:h-full lg:w-max lg:flex-row lg:items-center lg:gap-0 lg:px-0 lg:pb-0 lg:pt-0">
                {MILESTONES.map((m, i) => (
...
function PullQuote() {
    ...
    return (
        <section ref={rootRef} className="relative w-full overflow-hidden border-t border-black/10 bg-[#EEE8D9] py-28 transition-colors duration-300 md:py-40 dark:border-white/10 dark:bg-[#0A0A0A]">
