...
function Capabilities() {
    ...
    return (
        <section ref={rootRef} className="w-full bg-[#EEE8D9]   py-10 md:py-16 lg:py-28">
                        ...
                        <ol className="mt-10 flex flex-col gap-1">
                            {SERVICES.map((s, i) => (
                                <li key={s.title}>
                                    ...
                                    >
                                        <span
                                            className={`font-tommy-medium text-[13px] tabular-nums  ${active === i ? 'text-[#C8992B]' : 'text-black/30'}`}
                                        >
                                            {String(i + 1).padStart(2, '0')}
                                        </span>
                                        <span
                                            className={`font-tommy-medium text-[19px]  ${active === i ? 'text-[#1A1917]' : 'text-black/35'}`}
                                        >
                                            {s.title}
                                        </span>
                                        <span
...
function Process() {
    ...
    return (
        <section ref={rootRef} className="w-full border-y border-black/10 bg-[#E7E0CE]  text-[#1A1917]  py-10 md:py-16 lg:py-32">
...
function MeasurementStack() {
    return (
        <section className="w-full bg-[#EEE8D9]   py-10 md:py-16 lg:py-32">
            <div className="mx-auto max-w-[1280px] px-6 md:px-12">
                ...
                <Reveal className="mt-14 grid grid-cols-1 gap-px overflow-hidden rounded-[20px] border border-black/10 bg-black/10 md:grid-cols-2" y={40} stagger={0.12}>
                    {STACK.map((s, i) => (
                        <div key={s.k} className="bg-[#EEE8D9] p-4 md:p-6 lg:p-8  md:p-10">
