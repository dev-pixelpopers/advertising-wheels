...
const PROJECTS: Project[] = [
    ...
    { brand: 'Wendy’s', industry: 'Quick-Service Food', result: 'High-impact visual messaging, quick to implement, unusually cost-effective and highly measurable.', metric: 'Days', metricLabel: 'To launch', logo: `${LOGOS}/partner-wendys.webp`, slug: 'wendys', url: 'https://www.wendys.com' },
    { brand: 'Nationwide', industry: 'Insurance', result: 'Mobile billboards became the highlight of Nationwide’s market presence — and are still talked about today.', metric: 'City', metricLabel: 'Wide recall', logo: `${LOGOS}/partner-nationwide.webp`, slug: 'nationwide', url: 'https://www.nationwide.com' },
    { brand: 'Raising Cane’s', industry: 'Quick-Service Food', result: 'Pre-opening trade-area flights introduced the brand weeks before each new restaurant opened its lane.', metric: '3wk', metricLabel: 'Pre-opening presence', logo: `${LOGOS}/canes.webp`, slug: 'raising-canes', url: 'https://www.raisingcanes.com' },
    { brand: 'Dollar', industry: 'Car Rental', result: 'An OOH-vs-control study lifted Dollar.com peak-week visits +32% YoY in target markets, outperforming control in every flight.', metric: '+32%', metricLabel: 'YoY site visits', logo: `${LOGOS}/dollar-car-rental-logo.webp`, slug: 'dollar', url: 'https://www.dollar.com' },
    { brand: 'Floor & Decor', industry: 'Specialty Retail', result: `A six-truck Boston fleet carried two simultaneous store openings through the metro's homeowner neighborhoods and retail corridors.`, metric: '2', metricLabel: 'Stores launched', logo: `${LOGOS}/partner-floor-decor.webp`, slug: 'floor-and-decor', url: 'https://www.flooranddecor.com' },
    { brand: 'Outer', industry: 'DTC Home & Outdoor', result: 'A digitally-native furniture brand gained a seven-day physical presence on LA’s Westside design streets.', metric: '7d', metricLabel: 'Weekly presence', logo: `${LOGOS}/outer.webp`, slug: 'outer', url: 'https://liveouter.com' },
    { brand: 'Reliable Heating & Air', industry: 'Home Services', result: 'Offer-led wraps kept a hard system price on residential streets across the Atlanta service area, season after season.', metric: '100%', metricLabel: 'In-footprint miles', logo: `${LOGOS}/partner-reliable.webp`, slug: 'reliable-heating-cooling', url: 'https://reliable.com' },
    { brand: 'Burger King', industry: 'Quick-Service Food', result: 'A foot-traffic and limited-time-offer push carried through restaurant trade areas all day — including every breakfast, lunch, and dinner rush.', metric: 'Peak', metricLabel: 'Meal-time reach', logo: `${LOGOS}/burger-king-logo.webp`, slug: 'burger-king', url: 'https://www.bk.com' },
    { brand: 'AAA', industry: 'Travel & Mobility', result: 'A membership and roadside-assistance awareness plan carried through commuter corridors and travel hubs.', metric: 'Routes', metricLabel: 'Commuter reach', logo: `${LOGOS}/aaa-vector-logo.webp`, slug: 'aaa', url: 'https://www.aaa.com' },
    { brand: 'Saks Fifth Avenue', industry: 'Luxury Retail', result: 'The team executed outstanding results — recognition was city-wide, and memorable.', metric: '#1', metricLabel: 'In-market buzz', logo: `${LOGOS}/partner-saks-white.webp`, url: 'https://www.saksfifthavenue.com' },
    { brand: 'Cuyahoga CC', industry: 'Education', result: 'Campaign earned a regional gold medal for outdoor advertising from the NCMPR — and a national nomination.', metric: 'Gold', metricLabel: 'NCMPR award', logo: `${LOGOS}/partner-cuyahoga.webp`, slug: 'cuyahoga-community-college', url: 'https://www.tri-c.edu' },
];
